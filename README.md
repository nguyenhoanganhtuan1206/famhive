...
[![Lint](https://github.com/NovahubTechnology/family-backend-v2/actions/workflows/lint.yml/badge.svg)](https://github.com/NovahubTechnology/family-backend-v2/actions/workflows/lint.yml)
...
To release the WebApp, run

```bash
chmod +x scripts/release.sh (optional)
